...
const Home = () => {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden overflow-y-auto bg-white">
      ...
      {/* Header - Fixed */}
      <header className="fixed w-full bg-white/95 backdrop-blur-sm top-0 z-50 shadow-sm">
      ...
      <main className="relative w-full pt-[72px]">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className={`p-8 rounded-2xl border-2 transition-all duration-500 transform hover:scale-105 ${index === currentFeature
        ...
        {/* CTA Section */}
        <section className="relative py-12 sm:py-20 px-4 sm:px-6 bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
          {/* Background Pattern */}
        ...
        {/* Footer */}
        <footer className="relative w-full py-12 sm:py-16 px-4 sm:px-6 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white">
          <div className="container mx-auto relative z-10">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
              {/* Brand Section */}
              <div className="flex flex-col items-center sm:items-start col-span-1 lg:col-span-2">
                ...
                <p className="text-gray-300 text-sm leading-relaxed text-center sm:text-left max-w-sm">
              ...
              <div className="flex flex-col items-center sm:items-start">
                ...
                <div className="flex flex-col items-center sm:items-start space-y-2">
                  ...
                  <Link to="/login" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                    Login
                  </Link>
                  <Link to="/signup" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                    Sign Up
                  </Link>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center sm:items-start">
                ...
                <div className="flex flex-col items-center sm:items-start space-y-2">
                  <a href="mailto:support@tsfchat.com" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                    support@tsfchat.com
                  </a>
                  <a href="https://github.com/yourusername/TSF-Chats" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                    GitHub
                  </a>
                </div>
              </div>
